...
Commit  = '856cb5fbef84765698b2a9dc391657a6bcf9a1eb'   #最新版commit编号，log中找不到时，使用它
repo_path = "/Users/apple/Git/struts"
        ...
        for each_file in filename:
            if each_file.endswith(".xls"):
                    ...
                    for i in range(1,sheet.nrows):
                        ...
                        All_3partAPI_set.append( API_short )#换用列表，便于检查
...
def getfixedfile():
    #读取出目前已有的路径
    workbook0 = xlrd.open_workbook(r'/Users/apple/Documents/API/Struts2/repo_SrcfileInfo.xls')
    ...
    #print    file_list
    workbook = xlrd.open_workbook(r'/Users/apple/Documents/API/Struts2/Struts2.xlsx')
    ...
    for j in range(4,1004):
        ...
        x=0
        while 1:
            filename='/Users/apple/Documents/API/Struts2/Struts2-attachments/'+issuekey+'_'+str(x)+'.patch'
            x = x + 1
            try:
                #获取patch中设计的源代码文件
...
def getSrcvariable_Info_git(issuekey,file_name):
    ...
    #    pass   因为增加了  log中没有时：退回最新版，所以注释掉
        #print issuekey
    try:
    ...
    try:
        ...
        pass
    file_name = repo_path +'/'+ file_name [file_name.find('/'):]#因为有些是 项目名开头的，会有重复
...
def getUsedAPI(fixedfile_result):
    ...
    for j in range(4,1004):
        ...
        while 1:
            ...
            x = x + 1
            """
            #本来这里为了去掉无用的issuekey（无fixed file），但是为了找到尽可能多的API，所以注释掉这个功能
            try:
...
def write(Used_API):
    ...
    for key in Used_API:
        ...
        i = i+1
    f.save('/Users/apple/Documents/API/Struts2/issuekeys_UsedAPI.xls')#保存文件 
