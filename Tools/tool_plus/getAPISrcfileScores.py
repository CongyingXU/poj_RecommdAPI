...
def Info_IO():
    ##########################################
    #注意文件名   序号的修改
    dir0 = 'Output/Hbase_FeaturnLocation_result.xls' 
    ...
    Srcfileinfo_dir = 'Output/Hbase_repo_SrcfileInfo.xls'
...
text0_result_dict={}
text1_result_dict={}
with open("Input/Hbase_API_Src_Scores0.csv","r") as csvfile:
...
with open("Input/Hbase_API_Src_Scores1.csv","r") as csvfile:
        reader = csv.reader(csvfile)
        #这里不需要readlines
        for i,rows in enumerate(reader):
            if i+4 in num_list:
