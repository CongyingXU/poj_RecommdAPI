...
def getAimList():
    ...
    Aimresult={}
    import csv
    with open('app0/Computing_recommendation/Input/'+ poj+'Attachments_PatchInfo.csv',"r") as csvfile:
...
def getall_result():
    ...
    #定向制作
    Src_info_file_dir='app0/Computing_recommendation/Output/'+ poj+'_repo_SrcfileInfo.xls'
    workbook = xlrd.open_workbook(Src_info_file_dir,'r')
    sheet1 = workbook.sheet_by_name('sheet1')
    #因为数据量小，所以代码没有优化，
    #正式使用前，一定会要  优化！！！！
