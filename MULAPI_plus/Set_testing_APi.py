...
@author: Congying.Xu
得到90%训练集参数之后，用来对10%的测试集进行测试，得到相关的评估指标分数
"""
print 'start'
import evaluate 
...
def getevaluate(weights):
    ...
    getRecmdAPI_result.write( Result_dict, evaluate_result)
...
def getAimList():
    workbook = xlrd.open_workbook(r'Input/CXF_issuekeys_UsedAPI.xls')
...
weights = [1, 1, 0.10000000000000014, 1, 1, 0, 0, 1.0, 0.5000000000000001, 0.40000000000000013, 0.20000000000000015, 0.10000000000000014]




print 1
APISimilarReportsScores_dict  = getSimilarityScores2Reports.main_API(weights[5:])
print 2
